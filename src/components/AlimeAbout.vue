<template>
              ...
              <div class="classy-menu">
                ...
                <div class="classynav">
                  <ul id="nav">
                    ...
                    <li class="active"><a :href="`/${this.$i18n.locale}/about`">About</a></li>
                    <li><a :href="`/${this.$i18n.locale}/gallery`">Gallery</a></li>
                    <li><a :href="`/${this.$i18n.locale}/blog`">Blog</a></li>
                    <li><a :href="`/${this.$i18n.locale}/contact`">Contact</a></li>
                  </ul>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-12 col-lg-6">
            <div class="about-video-area mb-80 wow fadeInUp" data-wow-delay="100ms">
              <img src="/alime/img/bg-img/17.jpg" alt="">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-xl-3">
            <div class="team-content-area text-center mb-30 wow fadeInUp" data-wow-delay="100ms">
              <div class="member-thumb">
                <img src="/alime/img/bg-img/19.jpg" alt="">
              </div>
              <h5>Andrew Dean</h5>
          ...
          <div class="col-md-6 col-xl-3">
            <div class="team-content-area text-center mb-30 wow fadeInUp" data-wow-delay="300ms">
              <div class="member-thumb">
                <img src="/alime/img/bg-img/20.jpg" alt="">
              </div>
              <h5>Tommy Kim</h5>
              <span>Photographer</span>
              <div class="member-social-info">
          ...
          <div class="col-md-6 col-xl-3">
            <div class="team-content-area text-center mb-30 wow fadeInUp" data-wow-delay="500ms">
              <div class="member-thumb">
                <img src="/alime/img/bg-img/21.jpg" alt="">
              </div>
              <h5>Max McCormick</h5>
              <span>Photographer</span>
              <div class="member-social-info">
          ...
          <div class="col-md-6 col-xl-3">
            <div class="team-content-area text-center mb-30 wow fadeInUp" data-wow-delay="700ms">
              <div class="member-thumb">
                <img src="/alime/img/bg-img/22.jpg" alt="">
              </div>
              <h5>Robert Ward</h5>
              <span>Photographer</span>
              <div class="member-social-info">
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
              ...
              <div class="footer-logo">
                <a href="#"><img src="/alime/core-img/logo2.png" alt=""></a>
              </div>
              <!-- Social Info -->
