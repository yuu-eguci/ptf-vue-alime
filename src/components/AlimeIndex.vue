  ...
  <div>
        ...
        <div class="classy-nav-container breakpoint-off">
          <div class="container">
            ...
            <nav class="classy-navbar justify-content-between" id="alimeNav">
              ...
              <!-- Logo -->
              <a class="nav-brand" :href="`/${this.$i18n.locale}/index`"><img src="/alime/img/core-img/logo.png" alt=""></a>
              ...
              <div class="classy-menu">
                ...
                <div class="classynav">
                  <ul id="nav">
                    <li class="active"><a :href="`/${this.$i18n.locale}/index`">Home</a></li>
                    <li><a href="#">Pages</a>
                      <ul class="dropdown">
    ...
    <section class="welcome-area">
      <div class="welcome-slides owl-carousel">
        <!-- Single Slide -->
        <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(/alime/img/bg-img/1.jpg);">
        ...
        <!-- Single Slide -->
        <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(/alime/img/bg-img/2.jpg);">
          <div class="container h-100">
            <div class="row h-100 align-items-center">
              <!-- Welcome Text -->
              <div class="col-12 col-lg-8 col-xl-6">
        ...
        <div class="row alime-portfolio">
          ...
          <div class="col-12 col-sm-6 col-lg-3 single_gallery_item nature mb-30 wow fadeInUp" data-wow-delay="100ms">
            <div class="single-portfolio-content">
              <img src="/alime/img/bg-img/3.jpg" alt="">
              <div class="hover-content">
                <a href="/alime/img/bg-img/3.jpg" class="portfolio-img">+</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-lg-3 single_gallery_item video human mb-30 wow fadeInUp" data-wow-delay="300ms">
            <div class="single-portfolio-content">
              <img src="/alime/img/bg-img/4.jpg" alt="">
              <div class="hover-content">
                <a href="/alime/img/bg-img/4.jpg" class="portfolio-img">+</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-lg-3 single_gallery_item country mb-30 wow fadeInUp" data-wow-delay="500ms">
            <div class="single-portfolio-content">
              <img src="/alime/img/bg-img/5.jpg" alt="">
              <div class="hover-content">
                <a href="/alime/img/bg-img/5.jpg" class="portfolio-img">+</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-lg-3 single_gallery_item human mb-30 wow fadeInUp" data-wow-delay="700ms">
            <div class="single-portfolio-content">
              <img src="/alime/img/bg-img/6.jpg" alt="">
              <div class="hover-content">
                <a href="/alime/img/bg-img/6.jpg" class="portfolio-img">+</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-lg-3 single_gallery_item nature mb-30 wow fadeInUp" data-wow-delay="100ms">
            <div class="single-portfolio-content">
              <img src="/alime/img/bg-img/7.jpg" alt="">
              <div class="hover-content">
                <a href="/alime/img/bg-img/7.jpg" class="portfolio-img">+</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-lg-3 single_gallery_item video country mb-30 wow fadeInUp" data-wow-delay="300ms">
            <div class="single-portfolio-content">
              <img src="/alime/img/bg-img/8.jpg" alt="">
              <div class="hover-content">
                <a href="/alime/img/bg-img/8.jpg" class="portfolio-img">+</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-lg-3 single_gallery_item human mb-30 wow fadeInUp" data-wow-delay="500ms">
            <div class="single-portfolio-content">
              <img src="/alime/img/bg-img/10.jpg" alt="">
              <div class="hover-content">
                <a href="/alime/img/bg-img/10.jpg" class="portfolio-img">+</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-lg-3 single_gallery_item nature mb-30 wow fadeInUp" data-wow-delay="700ms">
            <div class="single-portfolio-content">
              <img src="/alime/img/bg-img/9.jpg" alt="">
              <div class="hover-content">
                <a href="/alime/img/bg-img/9.jpg" class="portfolio-img">+</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-lg-6 single_gallery_item video country mb-30 wow fadeInUp" data-wow-delay="100ms">
            <div class="single-portfolio-content">
              <img src="/alime/img/bg-img/36.jpg" alt="">
              <div class="hover-content">
                <a href="/alime/img/bg-img/36.jpg" class="portfolio-img">+</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-lg-3 single_gallery_item human mb-30 wow fadeInUp" data-wow-delay="300ms">
            <div class="single-portfolio-content">
              <img src="/alime/img/bg-img/37.jpg" alt="">
              <div class="hover-content">
                <a href="/alime/img/bg-img/37.jpg" class="portfolio-img">+</a>
              </div>
            </div>
          </div>
