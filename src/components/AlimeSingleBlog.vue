<template>
  <div>
              ...
              <div class="classy-menu">
                ...
                <div class="classynav">
                  <ul id="nav">
                    ...
                    <li><a :href="`/${this.$i18n.locale}/about`">About</a></li>
                    <li><a :href="`/${this.$i18n.locale}/gallery`">Gallery</a></li>
                    <li class="active"><a :href="`/${this.$i18n.locale}/blog`">Blog</a></li>
                    <li><a :href="`/${this.$i18n.locale}/contact`">Contact</a></li>
                  </ul>
    ...
    <section class="breadcrumb-area blog bg-img bg-overlay jarallax" style="background-image: url(/alime/img/bg-img/18.jpg);">
                  ...
                  <div class="col-12 col-lg-8">
                    <div class="row">
                      <div class="col-12 col-sm-6">
                        <img class="mb-10" src="/alime/img/bg-img/60.jpg" alt="">
                      </div>
                      <div class="col-12 col-sm-6">
                        <img class="mb-10" src="/alime/img/bg-img/61.jpg" alt="">
                      </div>
                      <div class="col-12">
                        <img class="mb-10" src="/alime/img/bg-img/63.jpg" alt="">
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-lg-4">
                    <img class="mb-10" src="/alime/img/bg-img/62.jpg" alt="">
                  </div>
                </div>
              </div>
    ...
    <div class="alime-pager-area section-padding-0-80">
      <div class="container">
        <div class="row no-gutters">
          <!-- Previous -->
          <div class="col-6">
            <div class="previous bg-img" style="background-image: url(/alime/img/bg-img/5.jpg);">
          ...
          <!-- Next -->
          <div class="col-6">
            <div class="next bg-img" style="background-image: url(/alime/img/bg-img/49.jpg);">
              <div class="overlay-content d-flex align-items-center justify-content-center">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="single-post-area">
              <!-- Post Thumbnail -->
              <a href="#" class="post-thumbnail"><img src="/alime/img/bg-img/52.jpg" alt=""></a>
              <!-- Post Catagory -->
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="single-post-area">
              <!-- Post Thumbnail -->
              <a href="#" class="post-thumbnail"><img src="/alime/img/bg-img/53.jpg" alt=""></a>
              <!-- Post Catagory -->
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="single-post-area">
              <!-- Post Thumbnail -->
              <a href="#" class="post-thumbnail"><img src="/alime/img/bg-img/54.jpg" alt=""></a>
              <!-- Post Catagory -->
              <a href="#" class="btn post-catagory">Camera</a>
              <!-- Post Conetent -->
              <div class="post-content">
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="single-post-area">
              <!-- Post Thumbnail -->
              <a href="#" class="post-thumbnail"><img src="/alime/img/bg-img/55.jpg" alt=""></a>
              <!-- Post Catagory -->
              ...
              <ol>
                ...
                <li class="single_comment_area">
                  ...
                  <div class="comment-content d-flex">
                    ...
                    <div class="comment-author">
                      <img src="/alime/img/bg-img/32.jpg" alt="author">
                    </div>
                    <!-- Comment Meta -->
                  ...
                  <ol class="children">
                    <li class="single_comment_area">
                      ...
                      <div class="comment-content d-flex">
                        <!-- Comment Author -->
                        <div class="comment-author">
                          <img src="/alime/img/bg-img/33.jpg" alt="author">
                        </div>
                        <!-- Comment Meta -->
                        <div class="comment-meta">
                ...
                <li class="single_comment_area">
                  ...
                  <div class="comment-content d-flex">
                    <!-- Comment Author -->
                    <div class="comment-author">
                      <img src="/alime/img/bg-img/34.jpg" alt="author">
                    </div>
                    <!-- Comment Meta -->
                    <div class="comment-meta">
                      <a href="#" class="post-date">27 Aug 2018</a>
